...
(function($) {
    ...
    k.Dial = function () {
        ...
        this.listen = function () {
			...
			var s = this,
                mw = function (e) {
                            ...
                            var ori = e.originalEvent
								...
								/*[changed by me] - I multiplying expression in ()brackes 3-times, to increase scroll movement speed. */
                                ,v = parseInt(s.$.val()) + (deltaX>0 || deltaY>0 ? 1 : deltaX<0 || deltaY<0 ? -1 : 0) * 3;
			...
			/*[changed by me] - before action was binded to this.$.bind(...)*/
            $(document).bind(
                    "keydown"
                    ,function (e) {
                        ...
                        if (isNaN(kval)) {
							...
							/*[changed by me] - keydown excetions*/
                            (kc !== 13)         // enter
                            && (kc !== 8)       // bs
                            && (kc !== 9)       // tab
                            && (kc !== 189)     // -
                            ...
                            if ($.inArray(kc,[37,38,39,40]) > -1) {
                                ...
                                s.change(v);
								s.cH(v); /*[changed by me] - this method missed, I add this .cH(v) to trigger value change when key is down*/
								s._draw();
			...
			/* [changed by me] - Now I binding mousewheel action to all document.
            this.$c.bind("mousewheel DOMMouseScroll", mw);
            this.$.bind("mousewheel DOMMouseScroll", mw)
			*/
			$(document).bind("mousewheel DOMMouseScroll", mw)
